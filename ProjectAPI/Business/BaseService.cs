...
namespace Business
{
    public class BaseService<TEntity> where TEntity : class, new()
    {
        ...
        /// <summary>
        /// Consulta un solo registro por un atributo
        /// </summary>
        /// <param name="attributeName"></param>
        /// <param name="value"></param>
        /// <returns></returns> 
        public virtual TEntity FindByAttribute(string attributeName, object value)
        {
            return _BaseModel.FindByAttribute(attributeName,value);
        }

        /// <summary>
        /// Consulta los registros por un atributo
        /// </summary>
        /// <param name="attributeName"></param>
        /// <param name="value"></param>
        /// <returns></returns> 
        public virtual IQueryable<TEntity> FindByAttributeList(string attributeName, object value)
        {
            return _BaseModel.FindByAttributeList(attributeName, value);
        }
        ...
        /// <returns></returns>
        public virtual List<TEntity> CreateList(List<TEntity> entities)
        {
            return _BaseModel.CreateList(entities);
        }
        ...
        /// <summary>
        /// Elimina varias entidades (Guarda)
        /// </summary>
        /// <param name="entities"></param>
        /// <returns></returns>
        public virtual IQueryable<TEntity> DeleteList(IQueryable<TEntity> entities)
        {
            return _BaseModel.DeleteList(entities);
        }
